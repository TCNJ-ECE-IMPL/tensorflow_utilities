...
def parse_args():
    ...
    ogroup.add_argument('--no_copy',
                        help='If flag is set no images will be copied',
                        required=False,
                        action='store_true')
...
if __name__ == '__main__':
    ...
    if args.data_set_type == 'classification':
        dataset = ClassificationDataSet(data_set_name=args.data_set_name,
                                        data_set_type=args.data_set_type)

    dataset.build_data_set(input_image_dir=args.input_image_dir,
